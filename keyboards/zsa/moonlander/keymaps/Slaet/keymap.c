...
enum custom_keycodes {
    SS_ONREADY = SAFE_RANGE,
    SS_V2Zero = SAFE_RANGE,
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_ColemakDHm] = LAYOUT_moonlander(
    ...
    KC_MS_BTN2,     KC_A,           LT(_Godot,KC_R),  KC_S,               KC_T,               KC_G,           KC_TRANSPARENT,                  KC_MS_WH_DOWN,  KC_M,           KC_N,           KC_E,              LT(_Arrows,KC_I),   KC_O,           MT(MOD_RCTL, KC_QUOTE),
  ...
  [_Numbers] = LAYOUT_moonlander(
    ...
    KC_LEFT_SHIFT,  KC_HASH,        KC_DLR,         KC_LPRN,        KC_RPRN,        KC_DOT,         KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_UNDS,        KC_4,           KC_5,           KC_6,           KC_PLUS,        KC_MINUS,
    KC_TRANSPARENT, KC_SLASH,       KC_CIRC,        KC_LBRC,        KC_RBRC,        KC_TILD,                                                                        KC_EQUAL,       KC_1,           KC_2,           KC_3,           KC_BSLS,        KC_AMPR,
  ...
  [_Arrows] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT,     KC_PGDN,            KC_UP,          KC_PAGE_UP,     KC_TRANSPARENT,         KC_TRANSPARENT,             KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [_Godot] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, SS_ONREADY,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_EQUAL,       KC_UNDS,        KC_TRANSPARENT, KC_TRANSPARENT,                         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, SS_V2Zero,      KC_TRANSPARENT, KC_TRANSPARENT,                                                         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
...
const uint16_t PROGMEM combo_underscore[] = { KC_W, KC_F, COMBO_END};
const uint16_t PROGMEM combo_bootloader[] = { KC_1, KC_MINUS, COMBO_END};
